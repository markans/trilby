				...
				<div class="header-body">
					<div class="header-container container d-flex h-100">
						<div class="header-column flex-row flex-lg-column justify-content-center h-100">
							<div class="header-row flex-row justify-content-start justify-content-lg-center pt-2 pb-4">
								<div class="header-logo">
									<a href="index.html">
										<img alt="Huntingfield-lace-logo" src="img/logos/huntingfield-place-logo.png">
									</a>
								</div>
							</div>
							...
							<div class="header-row justify-content-end pb-lg-3">
								<p class="d-none d-lg-block text-1 pt-3">© 2022 Spec Property</p>
				...
				<div class="owl-carousel owl-carousel-light owl-carousel-light-init-fadeIn owl-theme manual dots-inside dots-horizontal-center show-dots-hover show-dots-xs dots-light nav-style-1 nav-inside nav-inside-plus nav-light nav-md nav-font-size-md show-nav-hover mb-0" data-plugin-options="{'autoplay': false}" style="height: 100vh;">
					<div class="owl-stage-outer">
						<div class="owl-stage">
									...
									<div class="row justify-content-center align-items-center h-100 d-none">
										<div class="col-lg-6 text-center">
											<div class="d-flex flex-column align-items-center justify-content-center h-100">
												...
												<p class="text-4-5 text-color-light font-weight-light text-center mb-4" data-plugin-animated-letters data-plugin-options="{'startDelay': 1000, 'minWindowWidth': 0, 'animationSpeed': 30}">Trusted by over 40,000 satisfied, Porto is a huge succes in the on of largest world's MarketPlace.</p>
												<a href="#" class="btn btn-primary btn-modern font-weight-bold text-3 rounded-0 btn-py-3 btn-px-5 mt-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="2300" data-plugin-options="{'minWindowWidth': 0}">GET STARTED NOW!</a>
											</div>
										</div>
									</div>
								</div>
							...
							<!-- Carousel Slide 2 -->
							<div class="owl-item position-relative video overlay overlay-color-primary overlay-show overlay-op-8" data-video-path="video/busy" data-plugin-video-background data-plugin-options="{'posterType': 'jpg', 'position': '50% 50%'}" style="height: 100vh;">
								<div class="container position-relative z-index-3 h-100">
